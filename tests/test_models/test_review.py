...
This module contains test cases to verify the functionality
of the Review class implementation.

Test Classes:
    - TestReview_instantiation: Tests object creation and attributes
    - TestReview_save: Tests the save method functionality
    - TestReview_to_dict: Tests dictionary representation methods
"""
import os
import models
import unittest
...
class TestReview_instantiation(unittest.TestCase):
    """Test suite for Review class instantiation methods and attributes"""
...
class TestReview_save(unittest.TestCase):
    """Test suite for the save method of Review class"""
...
class TestReview_to_dict(unittest.TestCase):
    """Test suite for the to_dict method of Review class"""
